...
Was written validation for user form data. The output should take into consideration following validation. Was added css
classes(red) to show errors validation.