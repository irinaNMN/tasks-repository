...
Create a "Book" object that has the given properties. And the following given methods. Create an object called "
rectangle" that has the given properties and the following getters and setters.